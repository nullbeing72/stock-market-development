  ...
  return (
    <div className="modal-overlay" onClick={handleOverlay}>
      <div className="modal-box">
        ...
        <div className="modal-title">About Ticker-Teller v1.1</div>
        <div className="modal-body">
          ...
          <ul>
            {[
              ...
              ['🤖', 'Autoencoder Deep Clustering', '— IDEC: 4-cluster latent-space risk analysis over all 31 features, year-wise high-risk membership'],
          ...
          <div className="modal-section">Autoencoder Deep Clustering Risk Analysis</div>
          <ul>
            <li><strong>Features:</strong> All 31 engineered columns — no manual feature selection; the AE learns which dimensions matter.</li>
            <li><strong>Phase 1 — AE pre-training:</strong> Symmetric fully-connected autoencoder (d→256→128→64→latent, mirrored decoder) trained with MSE reconstruction loss.</li>
            <li><strong>Phase 2 — Initialisation:</strong> k-Means (k=4) run in the latent space to seed cluster centres.</li>
            <li><strong>Phase 3 — Joint IDEC optimisation:</strong> L = λ·L_rec + (1−λ)·KL(P‖Q). Q is the Student-t soft assignment; P is the sharpened target distribution. Both AE weights and cluster centres are updated simultaneously.</li>
            <li><strong>High-risk identification:</strong> The cluster with the highest mean 21-day annualised volatility is labelled high-risk.</li>
            <li><strong>Year-wise values:</strong> Each day's Q score for the high-risk cluster is grouped by calendar year and averaged.</li>
          </ul>
          ...
          <ul>
            ...
            <li><strong>Directional penalty</strong> — relu(−sign(pred)·sign(target)) penalises wrong-sign predictions.</li>
