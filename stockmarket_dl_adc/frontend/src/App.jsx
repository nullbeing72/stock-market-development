/**
 * App.jsx — Ticker-Teller v1.1
 * Fixes:
 *  - TickerLogo extracted as shared component (was duplicated in App + Sidebar)
 *  - AdcRiskPanel integrated into Model Performance tab (replaces FcmRiskPanel)
 *  - Version string updated to 1.1
...
import AdcRiskPanel from './components/AdcRiskPanel.jsx'
      ...
      <div className="main-content">
        ...
        <div className="tt-header">
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            ...
            <div>
              ...
              <div className="tt-subtitle">
                CNN → BiLSTM → Attention &nbsp;·&nbsp; Monte Carlo Forecast &nbsp;·&nbsp; ADC Risk &nbsp;·&nbsp; 31 Features
              </div>
              {result && (
          ...
          <div className="tt-meta">
            ...
            <span className="tt-meta-version">v1.1</span>
          </div>
        </div>
              ...
              <>
                ...
                {activeTab === 'model' && (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                    {/* ADC Risk panel — sits at the top of Model Performance */}
                    <AdcRiskPanel adcRisk={result.adc_risk} />
...
function LandingView({ onAbout }) {
  const features = [
    ...
    { icon: '🤖', text: 'Autoencoder Deep Clustering (IDEC) risk analysis — 4-cluster latent-space risk membership' },
